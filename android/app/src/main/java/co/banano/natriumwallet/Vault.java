...
public class Vault {
    ...
    private static final String AUTOMATICALLY_KEYED_PREF_FILE_NAME = "co.ananos.anium.automaticallyKeyedPref";
    private static final String AUTOMATICALLY_KEYED_KEY_FILE_NAME = "co.ananos.anium.automaticallyKeyedKey";
    private static final String AUTOMATICALLY_KEYED_KEY_ALIAS = "co.ananos.anium.automaticallyKeyed";
