...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Kalium. Μόλις λάβετε BAAnanos, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 BAAnanos"),
    ...
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Kalium! Το καλύτερο πορτοφόλι για BAAnanos σε κινητά τηλέφωνα!"),
